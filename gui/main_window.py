...
class MainWindow(QMainWindow):
    ...
    def init_ui(self):
        ...
        self.left_panel.setVerticalScrollBarPolicy(Qt.ScrollBarPolicy.ScrollBarAsNeeded)
        ...
        left_content.setStyleSheet("QWidget { background: transparent; }")
        ...
        # Theme Selector
        left_layout.addWidget(QLabel("<h3>🎨 Theme</h3>"))
        left_layout.addWidget(self.create_theme_widget())
        
        # Quick Access
        left_layout.addWidget(QLabel("<h3>📁 Quick Access</h3>"))
        left_layout.addWidget(self.create_quick_access_widget())
        
        # Favorites
        left_layout.addWidget(QLabel("<h3>⭐ Favorites</h3>"))
        left_layout.addWidget(self.create_favorites_widget())
        
        # Recent Locations  
        left_layout.addWidget(QLabel("<h3>🕐 Recent</h3>"))
        left_layout.addWidget(self.create_recent_widget())
        
        # Coding Projects
        left_layout.addWidget(QLabel("<h3>💻 Projects</h3>"))
        left_layout.addWidget(self.create_projects_widget())
        
        # Templates
        left_layout.addWidget(QLabel("<h3>📋 Templates</h3>"))
        left_layout.addWidget(self.create_templates_widget())
        ...
        # ==================== MAIN CONTENT AREA ====================
        # ... rest stays the same, starting with self.right_panel = QWidget()
